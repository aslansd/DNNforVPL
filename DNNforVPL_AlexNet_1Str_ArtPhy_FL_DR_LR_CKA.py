...
def main():
    ...
    all_simulation_all_unit_activity_layer_1 = np.zeros((number_simulation, number_group, number_layer_freeze, num_sample_artiphysiology, 64), dtype = np.float32)
    all_simulation_all_unit_activity_layer_2 = np.zeros((number_simulation, number_group, number_layer_freeze, num_sample_artiphysiology, 192), dtype = np.float32)
    all_simulation_all_unit_activity_layer_3 = np.zeros((number_simulation, number_group, number_layer_freeze, num_sample_artiphysiology, 384), dtype = np.float32)
    all_simulation_all_unit_activity_layer_4 = np.zeros((number_simulation, number_group, number_layer_freeze, num_sample_artiphysiology, 256), dtype = np.float32)
    all_simulation_all_unit_activity_layer_5 = np.zeros((number_simulation, number_group, number_layer_freeze, num_sample_artiphysiology, 256), dtype = np.float32)
        
    # Cosine distance definition
    CosSim = nn.CosineSimilarity(dim = 0, eps = 1e-10)
       
    parent_folder = 'New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR_CKA'
    ...
    for simulation_counter in range(number_simulation):
        ...
        for group_training in ['group1', 'group2', 'group3', 'group4']:
            ...
            for layer_freeze in [None, 0, 3, 6, 8, 10]:
                ...
                all_simulation_all_unit_activity_layer_1[simulation_counter, group_counter, layer_freeze_counter, :, :] = all_unit_activity_Conv2d_1.mean(axis = (2, 3)).reshape(num_sample_artiphysiology, 64)
                all_simulation_all_unit_activity_layer_2[simulation_counter, group_counter, layer_freeze_counter, :, :] = all_unit_activity_Conv2d_2.mean(axis = (2, 3)).reshape(num_sample_artiphysiology, 192)
                all_simulation_all_unit_activity_layer_3[simulation_counter, group_counter, layer_freeze_counter, :, :] = all_unit_activity_Conv2d_3.mean(axis = (2, 3)).reshape(num_sample_artiphysiology, 384)
                all_simulation_all_unit_activity_layer_4[simulation_counter, group_counter, layer_freeze_counter, :, :] = all_unit_activity_Conv2d_4.mean(axis = (2, 3)).reshape(num_sample_artiphysiology, 256)
                all_simulation_all_unit_activity_layer_5[simulation_counter, group_counter, layer_freeze_counter, :, :] = all_unit_activity_Conv2d_5.mean(axis = (2, 3)).reshape(num_sample_artiphysiology, 256)
    ...
    for i in range(number_simulation):
        for j in range(i + 1, number_simulation):
            ...
            for group_counter in range(number_group):
                for layer_freeze_counter in range(number_layer_freeze):
                    all_simulation_all_CKA[counter, group_counter, 0, layer_freeze_counter] = 1 - feature_space_linear_cka(all_simulation_all_unit_activity_layer_1[i, group_counter, layer_freeze_counter], all_simulation_all_unit_activity_layer_1[j, group_counter, layer_freeze_counter], debiased = True)
                    all_simulation_all_CKA[counter, group_counter, 1, layer_freeze_counter] = 1 - feature_space_linear_cka(all_simulation_all_unit_activity_layer_2[i, group_counter, layer_freeze_counter], all_simulation_all_unit_activity_layer_2[j, group_counter, layer_freeze_counter], debiased = True)
                    all_simulation_all_CKA[counter, group_counter, 2, layer_freeze_counter] = 1 - feature_space_linear_cka(all_simulation_all_unit_activity_layer_3[i, group_counter, layer_freeze_counter], all_simulation_all_unit_activity_layer_3[j, group_counter, layer_freeze_counter], debiased = True)
                    all_simulation_all_CKA[counter, group_counter, 3, layer_freeze_counter] = 1 - feature_space_linear_cka(all_simulation_all_unit_activity_layer_4[i, group_counter, layer_freeze_counter], all_simulation_all_unit_activity_layer_4[j, group_counter, layer_freeze_counter], debiased = True)
                    all_simulation_all_CKA[counter, group_counter, 4, layer_freeze_counter] = 1 - feature_space_linear_cka(all_simulation_all_unit_activity_layer_5[i, group_counter, layer_freeze_counter], all_simulation_all_unit_activity_layer_5[j, group_counter, layer_freeze_counter], debiased = True)
    ...
    scipy.io.savemat(parent_folder + '/all_simulation_all_unit_activity_layer_1.mat', mdict = {'all_simulation_all_unit_activity_layer_1': all_simulation_all_unit_activity_layer_1})
    scipy.io.savemat(parent_folder + '/all_simulation_all_unit_activity_layer_2.mat', mdict = {'all_simulation_all_unit_activity_layer_2': all_simulation_all_unit_activity_layer_2})
    scipy.io.savemat(parent_folder + '/all_simulation_all_unit_activity_layer_3.mat', mdict = {'all_simulation_all_unit_activity_layer_3': all_simulation_all_unit_activity_layer_3})
    scipy.io.savemat(parent_folder + '/all_simulation_all_unit_activity_layer_4.mat', mdict = {'all_simulation_all_unit_activity_layer_4': all_simulation_all_unit_activity_layer_4})
    scipy.io.savemat(parent_folder + '/all_simulation_all_unit_activity_layer_5.mat', mdict = {'all_simulation_all_unit_activity_layer_5': all_simulation_all_unit_activity_layer_5})
