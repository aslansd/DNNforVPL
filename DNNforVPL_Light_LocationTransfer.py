...
def main():
    ...
    os.mkdir('New_Results_Light')
    
    for num_simulation in range(0, 50):
        print('Simulation:   ', num_simulation + 1)
        
        os.mkdir('New_Results_Light/Simulation_' + str(num_simulation + 1))
        ...
        for group_training in ['group1', 'group2', 'group3', 'group4']:
            ...
            os.mkdir('New_Results_Light/Simulation_' + str(num_simulation + 1) + '/' + group_training)
