...
def main():
    ...
    os.mkdir('New_Results_Light_New')
    
    for num_simulation in range(0, 50):
        print('Simulation:   ', num_simulation + 1)
        
        os.mkdir('New_Results_Light_New/Simulation_' + str(num_simulation + 1))
        ...
        for group_training in ['group1', 'group2', 'group3', 'group4']:
            ...
            os.mkdir('New_Results_Light_New/Simulation_' + str(num_simulation + 1) + '/' + group_training)
            ...
            for location_transfer in [1, 2]:
                ...
                os.mkdir('New_Results_Light_New/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/Location_' + str(location_transfer))
                ...
                for layer_freeze in [None, 0, 3]:                   
                    ...
                    # if layer_freeze == None:
                    #     os.mkdir('New_Results_Light_New/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/Location_' + str(location_transfer) + '/before_training')
                    #     saving_folder = 'New_Results_Light_New/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/Location_' + str(location_transfer) + '/before_training'
                    ...
                    #         all_central_unit_activity_Conv2d_1[i, :] = unit_activity_layer_0[0, :, 14, 14].detach().cpu().clone().numpy()
                    #         all_central_unit_activity_Conv2d_2[i, :] = unit_activity_layer_3[0, :, 6, 6].detach().cpu().clone().numpy()
                    ...
                    os.mkdir('New_Results_Light_New/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/Location_' + str(location_transfer) + '/after_training_' + str(layer_freeze))
                    saving_folder = 'New_Results_Light_New/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/Location_' + str(location_transfer) + '/after_training_' + str(layer_freeze)
                    ...
                    all_channel_importance_Conv2d_1 = np.zeros((num_sample_artiphysiology, 6, 28, 28), dtype = np.float32)
                    all_channel_importance_Conv2d_2 = np.zeros((num_sample_artiphysiology, 16, 13, 13), dtype = np.float32)
