...
def main():
    ...
    parent_folder = 'New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR_ID_MI'
    ...
    for i in range(number_layer_freeze):
        ...
        if i == 0:
            ...
            all_simulation_group_layer12345_MI = np.concatenate((all_simulation_all_MI_original[:, 0, 0, 0].flatten() - all_simulation_all_MI_original[:, 0, 1, 0].flatten(), all_simulation_all_MI_original[:, 0, 1, 0].flatten() - all_simulation_all_MI_original[:, 0, 2, 0].flatten(), all_simulation_all_MI_original[:, 0, 2, 0].flatten() - all_simulation_all_MI_original[:, 0, 3, 0].flatten(), all_simulation_all_MI_original[:, 0, 3, 0].flatten() - all_simulation_all_MI_original[:, 0, 4, 0].flatten(),
                                                                 all_simulation_all_MI_original[:, 1, 0, 0].flatten() - all_simulation_all_MI_original[:, 1, 1, 0].flatten(), all_simulation_all_MI_original[:, 1, 1, 0].flatten() - all_simulation_all_MI_original[:, 1, 2, 0].flatten(), all_simulation_all_MI_original[:, 1, 2, 0].flatten() - all_simulation_all_MI_original[:, 1, 3, 0].flatten(), all_simulation_all_MI_original[:, 1, 3, 0].flatten() - all_simulation_all_MI_original[:, 1, 4, 0].flatten(),
                                                                 all_simulation_all_MI_original[:, 2, 0, 0].flatten() - all_simulation_all_MI_original[:, 2, 1, 0].flatten(), all_simulation_all_MI_original[:, 2, 1, 0].flatten() - all_simulation_all_MI_original[:, 2, 2, 0].flatten(), all_simulation_all_MI_original[:, 2, 2, 0].flatten() - all_simulation_all_MI_original[:, 2, 3, 0].flatten(), all_simulation_all_MI_original[:, 2, 3, 0].flatten() - all_simulation_all_MI_original[:, 2, 4, 0].flatten(),
                                                                 all_simulation_all_MI_original[:, 3, 0, 0].flatten() - all_simulation_all_MI_original[:, 3, 1, 0].flatten(), all_simulation_all_MI_original[:, 3, 1, 0].flatten() - all_simulation_all_MI_original[:, 3, 2, 0].flatten(), all_simulation_all_MI_original[:, 3, 2, 0].flatten() - all_simulation_all_MI_original[:, 3, 3, 0].flatten(), all_simulation_all_MI_original[:, 3, 3, 0].flatten() - all_simulation_all_MI_original[:, 3, 4, 0].flatten()))
            
            df = pd.DataFrame({'MI': all_simulation_group_layer12345_MI,
                               'Simulation': np.concatenate((np.tile(np.arange(number_simulation), 4), number_simulation + np.tile(np.arange(number_simulation), 4), 2 * number_simulation + np.tile(np.arange(number_simulation), 4), 3 * number_simulation + np.tile(np.arange(number_simulation), 4))),
    ...
    for i in range(number_layer_freeze):
        ...
        if i == 0:
            ...
            all_simulation_group_layer12345_MI = np.concatenate((all_simulation_all_MI_noise[:, 0, 0, 0].flatten() - all_simulation_all_MI_noise[:, 0, 1, 0].flatten(), all_simulation_all_MI_noise[:, 0, 1, 0].flatten() - all_simulation_all_MI_noise[:, 0, 2, 0].flatten(), all_simulation_all_MI_noise[:, 0, 2, 0].flatten() - all_simulation_all_MI_noise[:, 0, 3, 0].flatten(), all_simulation_all_MI_noise[:, 0, 3, 0].flatten() - all_simulation_all_MI_noise[:, 0, 4, 0].flatten(),
                                                                 all_simulation_all_MI_noise[:, 1, 0, 0].flatten() - all_simulation_all_MI_noise[:, 1, 1, 0].flatten(), all_simulation_all_MI_noise[:, 1, 1, 0].flatten() - all_simulation_all_MI_noise[:, 1, 2, 0].flatten(), all_simulation_all_MI_noise[:, 1, 2, 0].flatten() - all_simulation_all_MI_noise[:, 1, 3, 0].flatten(), all_simulation_all_MI_noise[:, 1, 3, 0].flatten() - all_simulation_all_MI_noise[:, 1, 4, 0].flatten(),
                                                                 all_simulation_all_MI_noise[:, 2, 0, 0].flatten() - all_simulation_all_MI_noise[:, 2, 1, 0].flatten(), all_simulation_all_MI_noise[:, 2, 1, 0].flatten() - all_simulation_all_MI_noise[:, 2, 2, 0].flatten(), all_simulation_all_MI_noise[:, 2, 2, 0].flatten() - all_simulation_all_MI_noise[:, 2, 3, 0].flatten(), all_simulation_all_MI_noise[:, 2, 3, 0].flatten() - all_simulation_all_MI_noise[:, 2, 4, 0].flatten(),
                                                                 all_simulation_all_MI_noise[:, 3, 0, 0].flatten() - all_simulation_all_MI_noise[:, 3, 1, 0].flatten(), all_simulation_all_MI_noise[:, 3, 1, 0].flatten() - all_simulation_all_MI_noise[:, 3, 2, 0].flatten(), all_simulation_all_MI_noise[:, 3, 2, 0].flatten() - all_simulation_all_MI_noise[:, 3, 3, 0].flatten(), all_simulation_all_MI_noise[:, 3, 3, 0].flatten() - all_simulation_all_MI_noise[:, 3, 4, 0].flatten()))
