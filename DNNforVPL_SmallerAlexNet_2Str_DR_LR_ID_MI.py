...
### The smaller DNN models for VPL
...
def main():
    ...
    parent_folder = 'New_Results_SmallerAlexNet_2Str_DR_LR_ID_MI'
    ...
    for i in range(number_model):
        ...
        t_stat_1 = np.zeros(i + 1)
        t_stat_2 = np.zeros(i + 1)
        t_stat_3 = np.zeros(i + 1)
        t_stat_4 = np.zeros(i + 1)
        
        p_value_1 = np.zeros(i + 1)
        p_value_2 = np.zeros(i + 1)
        p_value_3 = np.zeros(i + 1)
