...
# epsilon = [eps_X, eps_Y] (optional): The vector of bandwidths for X and Y. If no epsilon is set, 
...
#		              or 'floor' which uses the simple floor function as hashing. For small dimensions, 'floor', and
