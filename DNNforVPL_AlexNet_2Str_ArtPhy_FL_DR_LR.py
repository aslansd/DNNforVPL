...
def main():
    ...
    os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR')
    
    ### The main variables
    
    all_simulation_unit_activity_all_channels_layer_1 = np.zeros((20, 4, 6, 21, 64), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_2 = np.zeros((20, 4, 6, 21, 192), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_3 = np.zeros((20, 4, 6, 21, 384), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_4 = np.zeros((20, 4, 6, 21, 256), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_5 = np.zeros((20, 4, 6, 21, 256), dtype = np.float32)
    
    all_simulation_layer_rotation_weight_layer_1 = np.zeros((20, 4, 6, 180), dtype = np.float32)
    all_simulation_layer_rotation_weight_layer_2 = np.zeros((20, 4, 6, 180), dtype = np.float32)
    all_simulation_layer_rotation_weight_layer_3 = np.zeros((20, 4, 6, 180), dtype = np.float32)
    all_simulation_layer_rotation_weight_layer_4 = np.zeros((20, 4, 6, 180), dtype = np.float32)
    all_simulation_layer_rotation_weight_layer_5 = np.zeros((20, 4, 6, 180), dtype = np.float32)
    
    for num_simulation in range(0, 20):
        print('Simulation:   ', num_simulation + 1)
        
        os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1))
        ...
        for group_training in ['group1', 'group2', 'group3', 'group4']:
            ...
            os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training)
            ...
            for layer_freeze in [None, 0, 3, 6, 8, 10]:
                ...
                if layer_freeze == None:
                    os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/before_training')
                    saving_folder = 'New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/before_training'
                ...
                os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/after_training_' + str(layer_freeze))
                saving_folder = 'New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/after_training_' + str(layer_freeze)
                ...
                all_unit_activity_all_channels_analysis_layer_1 = np.zeros((len(SF_transfer) * len(Ori_transfer) + 1, 64, 55, 55), dtype = np.float32)
                all_unit_activity_all_channels_analysis_layer_2 = np.zeros((len(SF_transfer) * len(Ori_transfer) + 1, 192, 27, 27), dtype = np.float32)
                all_unit_activity_all_channels_analysis_layer_3 = np.zeros((len(SF_transfer) * len(Ori_transfer) + 1, 384, 13, 13), dtype = np.float32)
                all_unit_activity_all_channels_analysis_layer_4 = np.zeros((len(SF_transfer) * len(Ori_transfer) + 1, 256, 13, 13), dtype = np.float32)
                all_unit_activity_all_channels_analysis_layer_5 = np.zeros((len(SF_transfer) * len(Ori_transfer) + 1, 256, 13, 13), dtype = np.float32)
                
                for j in range(0, len(SF_transfer)):
                    for k in range(0, len(Ori_transfer)):
                        ...
                        all_unit_activity_all_channels_analysis_layer_1[j * len(SF_transfer) + k, :] = np.mean(all_unit_activity_Conv2d_1[indices, :], axis = 0)
                        all_unit_activity_all_channels_analysis_layer_2[j * len(SF_transfer) + k, :] = np.mean(all_unit_activity_Conv2d_2[indices, :], axis = 0)
                        all_unit_activity_all_channels_analysis_layer_3[j * len(SF_transfer) + k, :] = np.mean(all_unit_activity_Conv2d_3[indices, :], axis = 0)
                ...
                all_unit_activity_all_channels_analysis_layer_1[len(SF_transfer) * len(Ori_transfer), :] = all_unit_activity_ref_Conv2d_1[0, :]
                all_unit_activity_all_channels_analysis_layer_2[len(SF_transfer) * len(Ori_transfer), :] = all_unit_activity_ref_Conv2d_2[0, :]
                all_unit_activity_all_channels_analysis_layer_3[len(SF_transfer) * len(Ori_transfer), :] = all_unit_activity_ref_Conv2d_3[0, :]
                all_unit_activity_all_channels_analysis_layer_4[len(SF_transfer) * len(Ori_transfer), :] = all_unit_activity_ref_Conv2d_4[0, :]
                all_unit_activity_all_channels_analysis_layer_5[len(SF_transfer) * len(Ori_transfer), :] = all_unit_activity_ref_Conv2d_5[0, :]
    ...
    saving_folder = 'New_Results_AlexNet_2Str_ArtPhy_FL_DR_LR'
    
    scipy.io.savemat(saving_folder + '/all_simulation_unit_activity_all_channels_layer_1.mat', mdict={'all_simulation_unit_activity_all_channels_layer_1': all_simulation_unit_activity_all_channels_layer_1})
    scipy.io.savemat(saving_folder + '/all_simulation_unit_activity_all_channels_layer_2.mat', mdict={'all_simulation_unit_activity_all_channels_layer_2': all_simulation_unit_activity_all_channels_layer_2})
    scipy.io.savemat(saving_folder + '/all_simulation_unit_activity_all_channels_layer_3.mat', mdict={'all_simulation_unit_activity_all_channels_layer_3': all_simulation_unit_activity_all_channels_layer_3})
    scipy.io.savemat(saving_folder + '/all_simulation_unit_activity_all_channels_layer_4.mat', mdict={'all_simulation_unit_activity_all_channels_layer_4': all_simulation_unit_activity_all_channels_layer_4})
    scipy.io.savemat(saving_folder + '/all_simulation_unit_activity_all_channels_layer_5.mat', mdict={'all_simulation_unit_activity_all_channels_layer_5': all_simulation_unit_activity_all_channels_layer_5})
    
    scipy.io.savemat(saving_folder + '/all_simulation_layer_rotation_weight_layer_1.mat', mdict={'all_simulation_layer_rotation_weight_layer_1': all_simulation_layer_rotation_weight_layer_1})
    scipy.io.savemat(saving_folder + '/all_simulation_layer_rotation_weight_layer_2.mat', mdict={'all_simulation_layer_rotation_weight_layer_2': all_simulation_layer_rotation_weight_layer_2})
    scipy.io.savemat(saving_folder + '/all_simulation_layer_rotation_weight_layer_3.mat', mdict={'all_simulation_layer_rotation_weight_layer_3': all_simulation_layer_rotation_weight_layer_3})
    scipy.io.savemat(saving_folder + '/all_simulation_layer_rotation_weight_layer_4.mat', mdict={'all_simulation_layer_rotation_weight_layer_4': all_simulation_layer_rotation_weight_layer_4})
    scipy.io.savemat(saving_folder + '/all_simulation_layer_rotation_weight_layer_5.mat', mdict={'all_simulation_layer_rotation_weight_layer_5': all_simulation_layer_rotation_weight_layer_5})
    ...
    for i in range(4):
        for j in range(6):
            ...
            ax.fill_between(range(0, 180), all_simulation_layer_rotation_weight_layer_1.mean(0)[i, j] - all_simulation_layer_rotation_weight_layer_1.std(0)[i, j] / 20 ** 0.5, all_simulation_layer_rotation_weight_layer_1.mean(0)[i, j] + all_simulation_layer_rotation_weight_layer_1.std(0)[i, j] / 20 ** 0.5, alpha = 0.5, edgecolor = 'b', facecolor = 'b')
            
            ax.plot(range(0, 180), all_simulation_layer_rotation_weight_layer_2.mean(0)[i, j], "-g", label = "Conv Layer 2")
            ax.fill_between(range(0, 180), all_simulation_layer_rotation_weight_layer_2.mean(0)[i, j] - all_simulation_layer_rotation_weight_layer_2.std(0)[i, j] / 20 ** 0.5, all_simulation_layer_rotation_weight_layer_2.mean(0)[i, j] + all_simulation_layer_rotation_weight_layer_2.std(0)[i, j] / 20 ** 0.5, alpha = 0.5, edgecolor = 'g', facecolor = 'g')
                        
            ax.plot(range(0, 180), all_simulation_layer_rotation_weight_layer_3.mean(0)[i, j], "-r", label = "Conv Layer 3")
            ax.fill_between(range(0, 180), all_simulation_layer_rotation_weight_layer_3.mean(0)[i, j] - all_simulation_layer_rotation_weight_layer_3.std(0)[i, j] / 20 ** 0.5, all_simulation_layer_rotation_weight_layer_3.mean(0)[i, j] + all_simulation_layer_rotation_weight_layer_3.std(0)[i, j] / 20 ** 0.5, alpha = 0.5, edgecolor = 'r', facecolor = 'r')
            
            ax.plot(range(0, 180), all_simulation_layer_rotation_weight_layer_4.mean(0)[i, j], "-c", label = "Conv Layer 4")
            ax.fill_between(range(0, 180), all_simulation_layer_rotation_weight_layer_4.mean(0)[i, j] - all_simulation_layer_rotation_weight_layer_4.std(0)[i, j] / 20 ** 0.5, all_simulation_layer_rotation_weight_layer_4.mean(0)[i, j] + all_simulation_layer_rotation_weight_layer_4.std(0)[i, j] / 20 ** 0.5, alpha = 0.5, edgecolor = 'c', facecolor = 'c')
                        
            ax.plot(range(0, 180), all_simulation_layer_rotation_weight_layer_5.mean(0)[i, j], "-m", label = "Conv Layer 5")
            ax.fill_between(range(0, 180), all_simulation_layer_rotation_weight_layer_5.mean(0)[i, j] - all_simulation_layer_rotation_weight_layer_5.std(0)[i, j] / 20 ** 0.5, all_simulation_layer_rotation_weight_layer_5.mean(0)[i, j] + all_simulation_layer_rotation_weight_layer_5.std(0)[i, j] / 20 ** 0.5, alpha = 0.5, edgecolor = 'm', facecolor = 'm')
    ...
    for i in range(6):
        for j in range(4):
            label = 'group' + str(j + 1) + ' & ' + 'layer1'
            resp_dict[label] = all_simulation_unit_activity_all_channels_layer_1.mean(0)[j, i, :, :]
            
            label = 'group' + str(j + 1) + ' & ' + 'layer2'
            resp_dict[label] = all_simulation_unit_activity_all_channels_layer_2.mean(0)[j, i, :, :]
            
            label = 'group' + str(j + 1) + ' & ' + 'layer3'
            resp_dict[label] = all_simulation_unit_activity_all_channels_layer_3.mean(0)[j, i, :, :]
            
            label = 'group' + str(j + 1) + ' & ' + 'layer4'
            resp_dict[label] = all_simulation_unit_activity_all_channels_layer_4.mean(0)[j, i, :, :]
            
            label = 'group' + str(j + 1) + ' & ' + 'layer5'
            resp_dict[label] = all_simulation_unit_activity_all_channels_layer_5.mean(0)[j, i, :, :]
    
        plot_resp_lowd(resp_dict, i, 4, 5)
...
def plot_resp_lowd(resp_dict, layer_freeze, num_groups, num_layers):
    ...
    fig.suptitle('Dimensionality Reduction with PCA >>> Freezed Layer = ' + str(layer_freeze))
