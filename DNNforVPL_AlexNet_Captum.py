    ...
    for num_simulation in range(0, 50):
        ...
        for group_training in ['group1', 'group2', 'group3', 'group4']:
            ...
            for layer_freeze in [None]: # [0, 3, 6, 8, 10]
                ...
                all_channel_conductance_Conv2d_1 = np.zeros((num_sample_artiphysiology, 64, 55, 55), dtype = np.float32)
                all_channel_conductance_Conv2d_2 = np.zeros((num_sample_artiphysiology, 192, 27, 27), dtype = np.float32)
                all_channel_conductance_Conv2d_3 = np.zeros((num_sample_artiphysiology, 384, 13, 13), dtype = np.float32)
                all_channel_conductance_Conv2d_4 = np.zeros((num_sample_artiphysiology, 256, 13, 13), dtype = np.float32)
                all_channel_conductance_Conv2d_5 = np.zeros((num_sample_artiphysiology, 256, 13, 13), dtype = np.float32)
                ...
                for i in range(0, num_sample_artiphysiology):
                    ...
                    all_channel_conductance_Conv2d_1[i] = conductance_layer_conv_1.attribute(x_sample, baselines = x_baseline).detach().cpu().clone().numpy()
                    all_channel_conductance_Conv2d_2[i] = conductance_layer_conv_2.attribute(x_sample, baselines = x_baseline).detach().cpu().clone().numpy()
                ...
                scipy.io.savemat(saving_folder + '/all_channel_conductance_Conv2d_2.mat', mdict = {'all_channel_conductance_Conv2d_2': all_channel_conductance_Conv2d_2})
                scipy.io.savemat(saving_folder + '/all_channel_conductance_Conv2d_3.mat', mdict = {'all_channel_conductance_Conv2d_3': all_channel_conductance_Conv2d_3})
                scipy.io.savemat(saving_folder + '/all_channel_conductance_Conv2d_4.mat', mdict = {'all_channel_conductance_Conv2d_4': all_channel_conductance_Conv2d_4})
                scipy.io.savemat(saving_folder + '/all_channel_conductance_Conv2d_5.mat', mdict = {'all_channel_conductance_Conv2d_5': all_channel_conductance_Conv2d_5})
                ...
                mean_channel_conductance_Conv2d_1 = np.mean(all_channel_conductance_Conv2d_1, axis = (2, 3))
                mean_channel_conductance_Conv2d_2 = np.mean(all_channel_conductance_Conv2d_2, axis = (2, 3))
                mean_channel_conductance_Conv2d_3 = np.mean(all_channel_conductance_Conv2d_3, axis = (2, 3))
                mean_channel_conductance_Conv2d_4 = np.mean(all_channel_conductance_Conv2d_4, axis = (2, 3))
                mean_channel_conductance_Conv2d_5 = np.mean(all_channel_conductance_Conv2d_5, axis = (2, 3))
