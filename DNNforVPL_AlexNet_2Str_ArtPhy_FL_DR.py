...
def main():
    ...
    os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR')
    
    all_simulation_unit_activity_all_channels_layer_1 = np.zeros((10, 4, 21, 64 * 55 * 55), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_2 = np.zeros((10, 4, 21, 192 * 27 * 27), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_3 = np.zeros((10, 4, 21, 384 * 13 * 13), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_4 = np.zeros((10, 4, 21, 256 * 13 * 13), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_5 = np.zeros((10, 4, 21, 256 * 13 * 13), dtype = np.float32)
    
    for num_simulation in range(0, 10):
        print('Simulation:   ', num_simulation + 1)
        
        os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR/Simulation_' + str(num_simulation + 1))
        ...
        for group_training in ['group1', 'group2', 'group3', 'group4']:
            ...
            os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR/Simulation_' + str(num_simulation + 1) + '/' + group_training)
            ...
            for layer_freeze in [None]: # [0, 3, 6, 8, 10]
                ...
                if layer_freeze == None:
                    os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/before_training')
                    saving_folder = 'New_Results_AlexNet_2Str_ArtPhy_FL_DR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/before_training'
                ...
                os.mkdir('New_Results_AlexNet_2Str_ArtPhy_FL_DR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/after_training_' + str(layer_freeze))
                saving_folder = 'New_Results_AlexNet_2Str_ArtPhy_FL_DR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/after_training_' + str(layer_freeze)
                ...
                all_simulation_unit_activity_all_channels_layer_1[num_simulation, group_counter, :, :] = all_unit_activity_all_channels_analysis_layer_1.reshape(len(SF_transfer) * len(Ori_transfer) + 1, -1)
                all_simulation_unit_activity_all_channels_layer_2[num_simulation, group_counter, :, :] = all_unit_activity_all_channels_analysis_layer_2.reshape(len(SF_transfer) * len(Ori_transfer) + 1, -1)
                all_simulation_unit_activity_all_channels_layer_3[num_simulation, group_counter, :, :] = all_unit_activity_all_channels_analysis_layer_3.reshape(len(SF_transfer) * len(Ori_transfer) + 1, -1)
                all_simulation_unit_activity_all_channels_layer_4[num_simulation, group_counter, :, :] = all_unit_activity_all_channels_analysis_layer_4.reshape(len(SF_transfer) * len(Ori_transfer) + 1, -1)
                all_simulation_unit_activity_all_channels_layer_5[num_simulation, group_counter, :, :] = all_unit_activity_all_channels_analysis_layer_5.reshape(len(SF_transfer) * len(Ori_transfer) + 1, -1)
...
def plot_resp_lowd(resp_dict, num_groups, num_layers):
    ...
    for i, (label, resp) in enumerate(resp_dict.items()): 
        ...
        ax.scatter = plt.scatter(x, y, c = point_label, cmap = colours)
        ax.legend(handles = ax.scatter.legend_elements()[0], labels = classes)
