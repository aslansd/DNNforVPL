...
def main():
    ...
    os.mkdir('New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR')
    
    ### The main variables
    
    all_simulation_unit_activity_all_channels_layer_1 = np.zeros((20, 4, 6, 20, 64), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_2 = np.zeros((20, 4, 6, 20, 192), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_3 = np.zeros((20, 4, 6, 20, 384), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_4 = np.zeros((20, 4, 6, 20, 256), dtype = np.float32)
    all_simulation_unit_activity_all_channels_layer_5 = np.zeros((20, 4, 6, 20, 256), dtype = np.float32)
    ...
    for num_simulation in range(0, 20):
        ...
        os.mkdir('New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1))
        ...
        for group_training in ['group1', 'group2', 'group3', 'group4']:
            ...
            os.mkdir('New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training)
            ...
            for layer_freeze in [None, 0, 3, 6, 8, 10]:
                ...
                if layer_freeze == None:
                    os.mkdir('New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/before_training')
                    saving_folder = 'New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/before_training'
                ...
                os.mkdir('New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/after_training_' + str(layer_freeze))
                saving_folder = 'New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR/Simulation_' + str(num_simulation + 1) + '/' + group_training + '/after_training_' + str(layer_freeze)
                ...
                all_unit_activity_all_channels_analysis_layer_1 = np.zeros((len(SF_transfer) * len(Ori_transfer), 64, 55, 55), dtype = np.float32)
                all_unit_activity_all_channels_analysis_layer_2 = np.zeros((len(SF_transfer) * len(Ori_transfer), 192, 27, 27), dtype = np.float32)
                all_unit_activity_all_channels_analysis_layer_3 = np.zeros((len(SF_transfer) * len(Ori_transfer), 384, 13, 13), dtype = np.float32)
                all_unit_activity_all_channels_analysis_layer_4 = np.zeros((len(SF_transfer) * len(Ori_transfer), 256, 13, 13), dtype = np.float32)
                all_unit_activity_all_channels_analysis_layer_5 = np.zeros((len(SF_transfer) * len(Ori_transfer), 256, 13, 13), dtype = np.float32)
    ...
    saving_folder = 'New_Results_AlexNet_1Str_ArtPhy_FL_DR_LR'
